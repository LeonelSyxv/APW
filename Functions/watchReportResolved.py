...
def resolved_watcher(poll_interval=30, whatsapp_lock=None, recently_resolved_channels=None):
    ...
    previous_revision = {}
    initialized = False  # Avoid sending messages during the first loop
    ...
    while True:
        try:
            ...
            with conn.cursor() as cursor:
                ...
                if initialized:
                    # Identify channels that were in revision but no longer are (now resolved)
                    ...
                    for channel_id in resolved_ids:
                        ...
                        # Register channel as recently resolved
